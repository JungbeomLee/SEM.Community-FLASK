...
bp = Blueprint('flask_own_user_post', __name__, url_prefix='/user/own_user')
...
def user() :
    if request.method == 'POST' :
        ...
        if profile_image_name :
            check_user_profile_image_name = True
        else:
            check_user_profile_image_name = False
        cursor.execute('SELECT user_num FROM users WHERE email=%s', decode_user_token_email)
        user_num = str(cursor.fetchone()['user_num'])
        user_link_primary = user_num + user_nickname
        ...
        user_data = {'check_user_profile_image_name' : check_user_profile_image_name, 'user_link_primary' : user_link_primary, 'profile_image_name' : profile_image_name , 'user_name' : user_name, 'user_nickname' : user_nickname,'user_profile' : user_profile, 'user_created_at' : user_created_at, 'user_profile_image_link' : profile_image_link}
